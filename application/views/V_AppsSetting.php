<div class="row">
    ...
    <div class="col-6">
        <div class="card card-navy collapsed-card">
            ...
            <div class="card-body">
                <form id="form_expire" action="<?=base_url('parameter/C_Parameter/updateAppSetting')?>" method="post">
                    <div class="row">
                        <div class="col-12">
...
<div class="row mt-3">
    ...
    <div class="col-6">
        <div class="card card-navy collapsed-card">
            <div class="card-header card_header" style="cursor: pointer;" data-card-widget="collapse">
                <h3 class="card-title">MERCHANT CODE</h3>
            </div>
            <div class="card-body">
                <form id="form_merchant_code" action="<?=base_url('parameter/C_Parameter/updateAppSetting')?>" method="post">
                    <div class="row">
                        <div class="col-12 text-center">
                            <h6>Kode Merchant :</h6>
                            <strong><h3><?=$parameter_merchant_code['parameter_value'] == '' ? 'Kode Merchant belum dibuat' : $parameter_merchant_code['parameter_value'] ?></h3></strong>
                        </div>
                        <div class="col-12 text-center">
                            <br>
                            <label>Update To:</label><br>
                        ...
                        <div class="col-12">
                            <label>Kode Merchant Baru</label>
                            <input required type="text" class="form-control form-control-sm" autocomplete="off" name="parameter_value" value="" />
                            <input class="form-control form-control-sm" style="display: none;" value="PARAM_MERCHANT_CODE" name="parameter_name" />
                        </div>
                        <div class="col-12"><hr></div>
                        <div class="col-12">
                            <label>Username Programmer</label>
...
<div class="row mt-3">
    ...
    <div class="col-6">
        <div class="card card-navy collapsed-card">
            ...
            <div class="card-body">
                <form id="form_bios_serial_number" action="<?=base_url('parameter/C_Parameter/updateAppSetting')?>" method="post">
                    <div class="row">
                        <div class="col-12">
...
<div class="row mt-3">
    ...
    <div class="col-6">
        <div class="card card-navy collapsed-card">
            ...
            <div class="card-body">
                <form id="form_bios_back_date_setting" action="<?=base_url('parameter/C_Parameter/updateAppSetting')?>" method="post">
                    <div class="row">
                        <div class="col-12">
