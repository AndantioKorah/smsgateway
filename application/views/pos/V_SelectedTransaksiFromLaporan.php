        ...
        <div class="col-12">
            ...
            <div class="tab-content">
                <div id="transaksi_tab" class="tab-pane active">
                    ...
                    <div class="row mt-3" id="list_detail_transaksi" style="max-height: 310px; overflow-y: scroll;">
                    </div>
                </div>
...
<script>
    ...
    function loadPembayaran(){
        ...
        $('#pembayaran_tab').load('<?=base_url("pos/C_Pos/loadPembayaran/".$transaksi['id'].'/0')?>', function(){
            $('#laoder').hide()            
        })
    }
    ...
    function reloadListDetailTransaksi(){
        ...
        $('#list_detail_transaksi').load('<?=base_url("pos/C_Pos/loadDetailTransaksi/".$transaksi['id'].'/0')?>', function(){
            $('#laoder').hide()            
        })
    }
