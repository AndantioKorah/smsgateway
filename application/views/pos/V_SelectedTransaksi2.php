    ...
    <div class="card-header">
        <div class="row">
            <div class="col-3 text-left">
                <span class="label_header">No. Transaksi:</span> <h6><strong><?=$transaksi['nomor_transaksi']?></strong></h6>
            </div>
            ...
            <div class="col-3 text-center">
                ...
                <h6 id="status_val"><strong><?=getStatusTransaksi($transaksi['status'])?></strong></h6>
            </div>
    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-3 text-left mt-3">
                <button class="btn btn-block btn-navy" type="button"><i class="fa fa-print"></i> Cetak Bill</button>
            </div>
            <?php if($pembayaran){ ?>
                <div class="col-3 text-left mt-3">
                    <button class="btn btn-block btn-navy" type="button"><i class="fa fa-print"></i> Cetak Pembayaran</button>
                </div>
            <?php } ?>
        </div>
        <div class="row">
                        ...
                        <form id="detail_transaksi" class="mt-3">
                            <div class="row">
                                <div class="col-4">
                                    ...
                                    <select class="form-control form-control-sm select2_this select2-navy" data-dropdown-css-class="select2-navy" id="id_m_item_barang_select">
